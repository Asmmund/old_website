...
///////////////////////////////////////////////////////////// */  
    if( $GET['module'] && file_exists( SITE_ROOT. 'modules'.DIRECTORY_SEPARATOR.
      $modul. DIRECTORY_SEPARATOR. $GET['module']. '_controller.php' ) )
        include SITE_ROOT. 'modules'. DIRECTORY_SEPARATOR. $modul. 
      DIRECTORY_SEPARATOR. $GET['module']. '_controller.php';
    else
    {
...
/////////////////////////////////////////////////////////////////// */
    include  SITE_ROOT. 'modules'. DIRECTORY_SEPARATOR.  $modul.DIRECTORY_SEPARATOR. 'view.php';
